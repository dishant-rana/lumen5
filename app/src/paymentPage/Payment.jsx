...
const Payment = () => {
      ...
      {/* --------------left side box--------------- */}
        ...
        <div className={style.leftMain_Bx}>
          ...
          <div className={style.head1}>
            ...
            <p className={style.clr}>$708.00 <span className={style.span1}>per year</span> </p>
          </div>
        ...
        <div className={style.mainInp_Bx}>
          ...
          <div>
            <input className={style.inpBx_size1 + " " + style.cardInpBtm} placeholder="MM/YY"/>
          </div>
        ...
        <input style={{borderRadius:"07px"}} className={style.inpBx_size}/>
        </div>
  ...
  show? '' : <span className={style.uDropDwn} onClick={handleClick}>Enter address manually</span>
       ...
       <div>
       {
        ...
        <div className={style.btn}><p className={style.btnC}>Subscribe</p></div>
