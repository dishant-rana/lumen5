    ...
    <div>
        ...
        <div className={style.togglediv_main}>
            <div className={style.togglediv}>
                ...
                {price1=="$79"?( <div><div style={{background:"rgb(66, 66, 66)", color:"white"}} onClick={()=>{ amountChangeHandler1()}}>Bill Monthly</div>
                <div onClick={amountChangeHandler2}>Bill Yearly</div></div>):(<div><div  onClick={()=>{ amountChangeHandler1()}}>Bill Monthly</div>
                <div style={{background:"rgb(66, 66, 66)", color:"white"}} onClick={amountChangeHandler2}>Bill Yearly</div></div>)}
            </div>
        </div>
        <div>
        ...
        <div>
            <h3 className={style.over_6_million}>Over 6 million videos created by thousands of businesses</h3>
        </div>
        <div className={style.compareplan_div}>
            <div><button className={style.complare_plans_button}>Compare plans</button></div>
            <div className={style.or_div}>or</div>
            <div><button className={style.get_started_today_button}>Get started today</button></div>
        </div>
        <div className={style.users_container}>
            <div>
                <div className={style.user_img_div}>
                <img src="https://storage.googleapis.com/lumen5-site-images/comment-darren.png" alt="" />
                </div>
                <div>
                <p className={style.user_dis}>"A member from our ProBlogger group created a video using Lumen5 and published it on Facebook. In 24 hours the video got 300,000 views, just using this little tool."</p>
                </div>
                <div><p className={style.username}>DARREN ROWSE</p></div>
            </div>
            <div>
                <div className={style.user_img_div}><img src="https://storage.googleapis.com/lumen5-site-images/comment-nicholas.png" alt="" /></div>
                <div><p className={style.user_dis}>"By using Lumen5, we increased our Facebook engagements by 448%, and boosted our reach dramatically. Our page grew from 5,000 to 23,000 likes within a week!"</p></div>
                <div><p className={style.username}>NICHOLAS YANG</p></div>
            </div>
            <div>
                <div className={style.user_img_div}>
                <img src="https://storage.googleapis.com/lumen5-site-images/comment-tova.png" alt="" />
                </div>
                <div>
                <p className={style.user_dis}>"My first video already got over 650,000 views on my facebook page. It is an amazing program and I’m really impressed! It made converting a blog post into a video so easy."</p>
                </div>
                <div><p className={style.username}>TOVA LEIGH</p></div>
            </div>
            <div>
                <div className={style.user_img_div}> <img src="https://storage.googleapis.com/lumen5-site-images/comment-lauren.png" alt="" /></div>
                <div> <p className={style.user_dis}>"I created a video using an older blog post and it's been a huge hit! Great way to freshen up and share things again—170,000 views and climbing!"</p></div> 
                <div><p className={style.username}>LAUREN CASPER</p></div>
            </div>
            <div>
                <div className={style.user_img_div}> <img src="https://storage.googleapis.com/lumen5-site-images/comment-steve.png" alt="" /></div>
                <div> <p className={style.user_dis}>"Lumen5 is fantastic! I made a video and now it has gone viral! It has 22,000 views from a reach of 65,000. No advertising. No promotion."</p></div>
                <div><p className={style.username}>STEVE LAST</p></div>
            </div>
            <div>
                <div className={style.user_img_div}><img src="https://storage.googleapis.com/lumen5-site-images/comment-kaylene.png" alt="" /></div>
                <div><p className={style.user_dis}>"My Lumen5 video went viral with over3 million reach and it grew my page from 1500 to 5000 likes! I’m making these for all my top posts."</p></div>   
                <div><p className={style.username}>KAYLENE GEORGE</p></div>
            </div>
        </div>
        <div className={style.chooseplan_container}>
            <div>
                <h2 className={style.choose_the_plan}>Choose the plan that's right for you</h2>
            </div>
            ...
            <div>
                {/* space for table */}
                <div><h3 className={style.packName}>Usage</h3></div>
                <div>
        ...
        <div>
            ...
            <p>You can pay with Visa, Mastercard, and American Express. All prices are in USD. Invoiced billing is available on the Enterprise plan.</p>
        </div>
        </div>
        </div>
